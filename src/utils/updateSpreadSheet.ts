...
export default async function updateSpreadSheet(
  ...
  console.log('typeof GOOGLE_SERVICE_ACCOUNT_EMAIL', typeof process.env.GOOGLE_SERVICE_ACCOUNT_EMAIL);
  console.log('GOOGLE_PRIVATE_KEY', process.env.GOOGLE_PRIVATE_KEY);
  console.log('typeof GOOGLE_PRIVATE_KEY', typeof process.env.GOOGLE_PRIVATE_KEY);
